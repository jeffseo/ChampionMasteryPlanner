    ...
    def getChampionMasteryList(self, summonerId, limit=None):
        ...
        for champion in masteryJson:
            ...
            if champion['chestGranted']:
                currentChampionInfo.chestAvailability = "No"
            else:
                currentChampionInfo.chestAvailability = "Yes"   
        ...
        for championMastery in championAllJson:
            if championMastery['championId'] == championId:
                ...
                if championMastery['chestGranted']:
                    champion.chestAvailability = "No"
                else:
                    champion.chestAvailability = "Yes"   
                break
        return champion
